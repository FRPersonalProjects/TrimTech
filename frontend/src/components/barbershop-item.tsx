      ...
      <CardContent className="p-0 px-1 pt-1">
        ...
        {barbershop.imageUrl ? ( // se existir a imagem
          <div className="relative h-[159px] w-full">
            ...
            <Badge
              className="absolute left-2 top-2 space-x-1 bg-black/40 backdrop-blur-sm rounded-full"
              variant="secondary"
            >
              <StarIcon
                size={12}
        ...
        <div className="px-1 py-3">
          ...
          <div className="flex">
            <MapPinIcon className="text-gray-400 mr-1" size={18} />
            <p className="text-sm truncate text-gray-400">{barbershop.address}</p>
          </div>
          
          <Button
            variant="secondary"
            className="mt-3 w-full rounded-2xl text-primary"
          >
